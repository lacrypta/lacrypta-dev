...
cumplimiento a través de un mensaje directo (DM) a
[@lacryptaok en X/Twitter](https://twitter.com/lacryptaok). Todas las quejas
...
Los administradores de la comunidad seguirán estas Directrices de Impacto en la
...
solicitada con quienes se encargan de hacer cumplir el Código de Conducta, por
un periodo especificado de tiempo. Esto incluye evitar las interacciones en
...
encargan de hacer cumplir el Código de Conducta, durante este periodo.
...
pública dentro de la comunidad del proyecto.
...
Las Directrices de Impacto en la Comunidad están inspiradas en la
[escalera de aplicación del código de conducta de Mozilla][Mozilla CoC].

Para obtener respuestas a las preguntas frecuentes sobre este código de
conducta, consulta las Preguntas Frecuentes en
