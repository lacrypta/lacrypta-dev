...
import GamingHackathonCountdown from "./GamingHackathonCountdown";
    ...
    <section className="relative overflow-hidden border-b border-bitcoin/30 bg-[#05070e] pt-24 sm:pt-28">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 py-14 sm:px-6 sm:py-16 lg:grid-cols-[1fr_360px] lg:px-8">
        <div className="max-w-4xl">
          ...
          {upcoming && kickoffIso && (
            <GamingHackathonCountdown targetIso={kickoffIso} />
          )}
                ...
                <div key={rowIndex} className="flex gap-2">
                  {row.map((active, colIndex) => (
                    <span
                      ...
                      className={
                        active
                          ? "h-7 w-7 rounded-md bg-cyan shadow-[0_0_20px_rgba(34,211,238,0.58)] animate-pulse"
